class Solution 
{
	...
	public:
		...
		// This question allow unlimited transactions, 121 allows only one transaction.
		//
		// In this question:
		// 
		// sold is the maximum amount of money we have when we don't have any tock in hand.
		...
		// of the stock series problem, and look at the state transition graph on GitHub.
