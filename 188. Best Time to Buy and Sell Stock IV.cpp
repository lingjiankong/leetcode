...
public:
    int maxProfit(int k, vector<int>& prices) {
        ...
        vector<int> buy (k+1, INT_MIN); // the amount of money you have the ith time you buy (note i = 1 is records the 1st time you buy)
        vector<int> sell (k+1, 0); // the amount of money you have the ith time you sell (note i = 1 is records the 1st time you sell)
