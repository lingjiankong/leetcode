...
// Store state (bool flag which indicates whether to set each row/col to zero) of each row in the first element of that
// row, and store state of each column in the first element of that column. Because the state of row0 and the state of
// column0 would occupy the same cell, we define two bool: rowZero and colZero, to store the state of the first row, and
// first column.
