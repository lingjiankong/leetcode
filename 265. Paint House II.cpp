...
// For current house, as long as it is not the same color as the one which has previous minimum cost, add previous
// minimum cost to current cost. Repeat the process.
