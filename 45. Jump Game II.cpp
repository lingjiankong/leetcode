...
int jump(vector<int>& nums) {
    ...
    for (int i = 0; i < nums.size() - 1; ++i) {
        ...
        // window's end (i.e. new currentEnd) will be currentMaxReach. Why we have ;i<nums.size()-1;? Because if we had
        // ;i<nums.size();, we were including the last index, then another jump is triggered at last index, and our
        // totalJump will be 1 greater than what it should have been.
        if (i == currentEnd) {
            ++totalJump;
