...
vector<int> majorityElement(vector<int>& nums)
{
	...
	// What candidate1 and candidate2 equal to in the beginning can be arbitrary, it doesn't matter.
	...
	for (auto num : nums)
	{
		...
		else
		{
			...
			// we get rid of one pair of (candidate1, num), --count1,
			// and one pair of (candidate2, num), --count2
			--count1;
			--count2;
		}
	}
